...
class PostController extends Controller
{
	...
	public function actionCreate()
	{
		...
		$cs->registerScript('Yii.'.get_class($this).'#'.'_gz', $this->tinymcescript, CClientScript::POS_HEAD);
		$model=new Post;
